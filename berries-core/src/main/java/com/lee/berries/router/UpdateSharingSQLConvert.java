...
@Component("updateSharingSQLConvert")
public class UpdateSharingSQLConvert extends AbstractSharingSQLConvert implements SharingSQLConvert {

	@Resource
	TableSharings tableSharings;
	
	private static final String REXP = "update\\s+(.+)\\s+set";
